...
const AcademicSection = () => {
     ...
     return (
          <div className="min-h-screen bg-[#0B0B0B] text-[#F8FAFC] font-sans selection:bg-[#0706F1] selection:text-white">
                    ...
                    <div className="relative mx-auto max-w-6xl">
                         ...
                         >
                              <div className="inline-flex items-center gap-2 rounded-full border border-[#0706F1]/20 bg-[#0706F1]/5 px-3 py-1.5 backdrop-blur-sm sm:gap-3 sm:px-4 sm:py-2">
                                   <Trophy size={14} className="text-[#0706F1] sm:h-4 sm:w-4" />
                                   <span className="text-[10px] font-black uppercase tracking-[0.25em] text-[#0706F1] sm:text-xs sm:tracking-[0.3em]">
                              ...
                              <h2 className="text-4xl font-black uppercase leading-none tracking-tighter text-[#F8FAFC] sm:text-5xl md:text-6xl lg:text-7xl">
                                   Excellence<span className="text-[#0706F1]">.</span>
                              </h2>
                         ...
                         >
                              <p className="mb-1 text-[10px] font-medium uppercase tracking-widest text-[#0706F1] sm:text-xs">
                                   01 / Education & Honors
                              </p>
                         ...
                         >
                              {educationHonors.map((item, index) => (
                                   <motion.div
                                        key={item.title}
                                        variants={fadeUp}
                                        className="group relative overflow-hidden rounded-2xl border border-[#0706F1]/20 bg-gradient-to-br from-[#0706F1]/[0.08] via-[#111] to-[#111] p-6 transition-all duration-500 hover:border-[#0706F1]/40 hover:shadow-2xl hover:shadow-[#0706F1]/20 hover:-translate-y-2 sm:rounded-3xl sm:p-8 md:p-10"
                                   >
                                        <div className="absolute inset-0 bg-gradient-to-br from-[#0706F1]/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                                        ...
                                        <div className="relative">
                                             <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#0706F1]/20 to-[#0706F1]/5 text-primary ring-2 ring-[#0706F1]/30 transition-all duration-300 group-hover:scale-110 group-hover:ring-[#0706F1]/50 sm:mb-6 sm:h-16 sm:w-16">
                                                  {item.icon}
                                             </div>
                                             <span className="mb-3 inline-block rounded-full bg-[#0706F1]/15 px-3 py-0.5 text-[10px] font-bold uppercase tracking-widest text-[#0706F1] ring-1 ring-[#0706F1]/20 sm:mb-4">
                                                  {item.tag}
                                             </span>
                         ...
                         >
                              <div className="flex items-center gap-2 sm:gap-3">
                                   <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#0706F1]/10 text-xs font-black text-[#0706F1] ring-1 ring-[#0706F1]/20 sm:h-8 sm:w-8">
                                        02
                                   </span>
                                   <div>
                                        <p className="text-[10px] font-medium uppercase tracking-widest text-[#0706F1]/70 sm:text-xs">
                              ...
                              {accelerators.map((item) => (
                                   ...
                                   >
                                        ...
                                        <div className="relative">
                                             ...
                                             <h4 className="mb-1.5 text-sm font-bold leading-tight text-[#F8FAFC] transition-colors group-hover:text-[#0706F1] sm:mb-2 sm:text-base">
                                                  {item.title}
                                             </h4>
                         ...
                         >
                              {benchmarks.map((item) => (
                                   <motion.div
                                        key={item.title}
                                        variants={fadeUp}
                                        className="group relative overflow-hidden rounded-xl border border-slate-800 bg-gradient-to-br from-[#111] to-[#0706F1]/[0.02] transition-all duration-500 hover:border-[#0706F1]/40 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#0706F1]/10 sm:rounded-2xl"
                                   >
                                        <div className="h-1.5 w-full bg-gradient-to-r from-[#0706F1] via-[#0706F1]/60 to-[#0706F1]/20" />
                                        <div className="p-5 sm:p-6 md:p-7">
                                             <div className="mb-3 flex items-start justify-between gap-2 sm:mb-4">
                                                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-[#0706F1]/15 to-[#0706F1]/5 text-primary ring-1 ring-[#0706F1]/20 transition-all duration-300 group-hover:scale-110 sm:h-11 sm:w-11">
                                                       {item.icon}
                                                  </div>
                                                  <span className="rounded-full bg-[#0706F1]/10 px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-widest text-[#0706F1] ring-1 ring-[#0706F1]/20">
                                                       {item.status}
                                                  </span>
                                             </div>
                                             <h4 className="mb-1.5 text-base font-bold leading-tight text-[#F8FAFC] transition-colors group-hover:text-[#0706F1] sm:mb-2 sm:text-lg">
                                                  {item.title}
                                             </h4>
                                             <div className="flex items-center gap-2 text-[#0706F1]">
                                                  <ChevronRight size={14} />
                                                  <span className="text-xs font-mono tracking-tight text-slate-300">{item.goal}</span>
                                             </div>
                                        </div>
                                   </motion.div>
                              ))}
                         ...
                         >
                              {specializations.map((item) => (
                                   <motion.div
                                        key={item.title}
                                        variants={fadeUp}
                                        className="group relative overflow-hidden rounded-2xl border border-[#0706F1]/20 bg-gradient-to-br from-[#111] via-[#0706F1]/[0.03] to-[#111] p-6 transition-all duration-500 hover:border-[#0706F1]/40 hover:shadow-2xl hover:shadow-[#0706F1]/20 hover:-translate-y-2 sm:rounded-3xl sm:p-8"
                                   >
                                        ...
                                        <div className="relative">
                                             <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#0706F1]/20 to-[#0706F1]/5 text-primary ring-2 ring-[#0706F1]/30 transition-all duration-300 group-hover:scale-110 sm:h-14 sm:w-14">
                                                  {item.icon}
                                             </div>
                                             <h4 className="mb-2 text-lg font-black uppercase leading-tight tracking-tight text-[#F8FAFC] group-hover:text-[#0706F1] transition-colors">
                                                  {item.title}
                                             </h4>
                                             <p className="text-xs leading-relaxed text-slate-400 sm:text-sm">
                                                  {item.description}
